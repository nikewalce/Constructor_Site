...
class Constructor(models.Model):
    ...
    #здесь указывается та страница, на котоорую происходит переадресация пользователя, после того как просходит изменение в записи бд
    def get_absolute_url(self):
        #возвращать страницу, которая была изменена
